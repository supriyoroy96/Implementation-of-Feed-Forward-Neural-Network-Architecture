...
#CSV File to write hyperparameter for Part 2
hyp=['Epochs','Batch Size','Learning Rate','No of Hidden Layers','No of Units','Regulariser']
Name=[100,32,0.01,1,64,0]
part2 = list(zip(hyp,Name))
Part2 = pd.DataFrame(part2, columns=['Name', 'Value'])
Part2.to_csv('Part_2.csv', index=False)
